...
def validate(definition, data, handlers={}, format_checkers={}):
    """
    ...
    """
    return compile(definition, handlers, format_checkers)(data)


# pylint: disable=redefined-builtin,dangerous-default-value,exec-used
def compile(definition, handlers={}, format_checkers={}):
    """
    ...
    """
    resolver, code_generator = _factory(definition, handlers, format_checkers)
...
def _factory(definition, handlers, format_checkers={}):
    resolver = RefResolver.from_schema(definition, handlers=handlers)
    code_generator = _get_code_generator_class(definition)(definition, resolver=resolver, format_checkers=format_checkers)
